...
from json_log_parser.exceptions.filename_error import InvalidFilenameError
...
def test_validate_document_returns_nothing(validator, json_document):
    """
    validate_document only raises exception if validation fails
    """
...
def test_validate_document_slash_in_filename(validator, json_document):
    ...
    with pytest.raises(InvalidFilenameError) as err:
        validator.validate_document(json_document)
